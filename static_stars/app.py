...
texture_manager.load_atlas('/home/diego/python/kivent/examples/assets/background_objects.atlas')

class TestGame(Widget):
    def __init__(self, **kwargs):
        super(TestGame, self).__init__(**kwargs)
        #Add the GameSystem we are initializing o the args in init_gameworld
